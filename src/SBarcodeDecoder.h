...
public:
     ...
     * \param videoFrame - frame of video data.
     * \param captureRect - capture area rectangle.
     */
...
public slots:
     ...
     * \param capturedImage - captured image.
     * \param formats - barcode formats.
     */
